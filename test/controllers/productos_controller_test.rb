...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { code: @producto.code, price: @producto.price, title: @producto.title } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { code: @producto.code, price: @producto.price, title: @producto.title } }
